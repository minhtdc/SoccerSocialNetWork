 ...
 * Use the {@link FootballPitchesInfoFragment#newInstance} factory method to
...
public class FootballPitchesInfoFragment extends Fragment {
    ...
    public FootballPitchesInfoFragment() {
    ...
    public static FootballPitchesInfoFragment newInstance(String param1, String param2) {
        FootballPitchesInfoFragment fragment = new FootballPitchesInfoFragment();
